...
const ContentHub = dynamic(() => import("../components/ContentHub"));

const Components = { ContentHub };
...
const AppConfig = {
  ...
  configValues: [
    {
      name: "referenceNames",
      label: "List of Reference Names (seperated by comma, no space)",
      type: "string",
    },
